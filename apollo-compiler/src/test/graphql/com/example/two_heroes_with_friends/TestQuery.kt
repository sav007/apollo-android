...
class TestQuery : Query<TestQuery.Data, TestQuery.Data, Operation.Variables> {
    ...
    /**
     * @param id The ID of the character@param name The name of the character@param friendsConnection The friends of the character exposed as a connection with edges */
    data class Luke(
        val __typename: String,
        val id: String,
        val name: String,
