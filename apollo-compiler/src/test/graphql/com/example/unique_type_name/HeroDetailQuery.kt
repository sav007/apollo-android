...
class HeroDetailQuery : Query<HeroDetailQuery.Data, HeroDetailQuery.Data, Operation.Variables> {
    ...
    data class Friends1(val __typename: String, val fragments: Fragments) {
    ...
    /**
     * @param name The name of the character@param appearsIn The movies this character appears in@param friends The friends of the character, or an empty list if they have none */
    data class Friends(
    ...
    /**
     * @param name What this human calls themselves@param friends This human's friends, or an empty list if they have none@param height Height in the preferred unit, default is meters */
    data class AsHuman(
        val __typename: String,
        val name: String,
        ...
        companion object {
            ...
            operator fun invoke(reader: ResponseReader): AsHuman {
                val __typename = reader.readString(RESPONSE_FIELDS[0])
                val name = reader.readString(RESPONSE_FIELDS[1])
                val friends = reader.readList<Friends>(RESPONSE_FIELDS[2]) {
    ...
    /**
     * @param name The name of the character@param friends The friends of the character, or an empty list if they have none */
    data class HeroDetailQuery(
        ...
        companion object {
            ...
            operator fun invoke(reader: ResponseReader): HeroDetailQuery {
                val __typename = reader.readString(RESPONSE_FIELDS[0])
                val name = reader.readString(RESPONSE_FIELDS[1])
                val friends = reader.readList<Friends12>(RESPONSE_FIELDS[2]) {
