...
class TestQuery : Query<TestQuery.Data, TestQuery.Data, Operation.Variables> {
    ...
    /**
     * @param name The name of the character@param birthDate The date character was born.@param appearanceDates The dates of appearances@param fieldWithUnsupportedType The date character was born.@param profileLink Profile link@param links Links */
    data class Hero(
