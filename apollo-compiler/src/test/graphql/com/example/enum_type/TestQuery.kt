...
class TestQuery : Query<TestQuery.Data, TestQuery.Data, Operation.Variables> {
    ...
    /**
     * @param name The name of the character@param appearsIn The movies this character appears in@param firstAppearsIn The movie this character first appears in */
    data class Hero(
