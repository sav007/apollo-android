...
class TestQuery : Query<TestQuery.Data, TestQuery.Data, Operation.Variables> {
    ...
    data class Reviews(
        ...
        companion object {
            ...
            operator fun invoke(reader: ResponseReader): Reviews {
    ...
    data class Data(val reviews: List<Reviews>?) : Operation.Data {
        ...
        companion object {
            ...
            operator fun invoke(reader: ResponseReader): Data {
                val reviews = reader.readList<Reviews>(RESPONSE_FIELDS[0]) {
                    it.readObject<Reviews> {
                        Reviews(it)
                    }
