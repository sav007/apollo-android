...
class TestQuery : Query<TestQuery.Data, TestQuery.Data, Operation.Variables> {
    ...
    /**
     * @param name What this human calls themselves@param height Height in the preferred unit, default is meters@param friends This human's friends, or an empty list if they have none */
    data class AsHuman(
        val __typename: String,
        val name: String,
        val height: Double?,
