...
class AllStarshipsQuery : Query<AllStarshipsQuery.Data, AllStarshipsQuery.Data, Operation.Variables> {
    ...
    data class AllStarships(
        ...
        companion object {
            ...
            operator fun invoke(reader: ResponseReader): AllStarships {
                val __typename = reader.readString(RESPONSE_FIELDS[0])
                val edges = reader.readList<Edges>(RESPONSE_FIELDS[1]) {
                    it.readObject<Edges> {
                        Edges(it)
                    }
    ...
    data class Data(val allStarships: AllStarships?) : Operation.Data {
        ...
        companion object {
            ...
            operator fun invoke(reader: ResponseReader): Data {
                val allStarships = reader.readObject<AllStarships>(RESPONSE_FIELDS[0]) {
                    AllStarships(it)
                }
