...
/**
 * The input object sent when passing in a color@param red Red color@param green Green color@param blue Blue color@param enumWithDefaultValue for test purpose only */
