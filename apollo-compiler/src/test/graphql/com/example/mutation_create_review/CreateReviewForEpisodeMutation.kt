...
data class CreateReviewForEpisodeMutation(val ep: Episode, val review: ReviewInput) : Mutation<CreateReviewForEpisodeMutation.Data, CreateReviewForEpisodeMutation.Data, Operation.Variables> {
    ...
    /**
     * @param stars The number of stars this review gave, 1-5@param commentary Comment about the movie@param listOfListOfString for test purpose only@param listOfListOfEnum for test purpose only@param listOfListOfCustom for test purpose only@param listOfListOfObject for test purpose only */
    data class CreateReview(
        ...
        val listOfListOfObject: List<ListOfListOfObject>?
    ) {
        fun marshaller(): ResponseFieldMarshaller = ResponseFieldMarshaller {
            it.writeString(RESPONSE_FIELDS[0], __typename)
        ...
        companion object {
            ...
            operator fun invoke(reader: ResponseReader): CreateReview {
                ...
                val listOfListOfObject = reader.readList<ListOfListOfObject>(RESPONSE_FIELDS[6]) {
