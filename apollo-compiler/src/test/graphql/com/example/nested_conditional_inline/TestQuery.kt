...
data class TestQuery(val episode: Input<Episode>) : Query<TestQuery.Data, TestQuery.Data, Operation.Variables> {
    ...
    /**
     * @param name What this human calls themselves@param friends This human's friends, or an empty list if they have none */
    data class AsHuman(
        val __typename: String,
        val name: String,
    ...
    /**
     * @param name What others call this droid@param friends This droid's friends, or an empty list if they have none */
    data class AsDroid(
        val __typename: String,
        val name: String,
        ...
        companion object {
            ...
            operator fun invoke(reader: ResponseReader): AsDroid {
                val __typename = reader.readString(RESPONSE_FIELDS[0])
                val name = reader.readString(RESPONSE_FIELDS[1])
                val friends = reader.readList<Friends1>(RESPONSE_FIELDS[2]) {
